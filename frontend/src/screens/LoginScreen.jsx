...
const LoginScreen = () => {
    ...
    return (
        <div className="flex justify-center items-center min-h-screen bg-black pt-32 pb-24 relative overflow-hidden" style={{ fontFamily: 'Froople, sans-serif' }}>
            ...
            <div className="w-full max-w-md relative z-10 px-6">
                ...
                <div className="bg-[#0c0c0c] border border-[#1a1a1a] rounded-[16px] p-8 md:p-10 relative overflow-hidden">
                    ...
                    <div className="mt-8 text-center text-[#777] text-[12px] relative z-10 font-[500]">
                        New Customer? <Link to="/register" className="font-[700] text-[#ccc] hover:text-white transition-colors tracking-wide ml-1">Create Account</Link>
                    </div>
                </div>
            </div>
        </div>
